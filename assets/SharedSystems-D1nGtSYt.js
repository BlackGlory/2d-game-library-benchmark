...
let __tla = Promise.all([
  ...
  const me = class I extends Le {
    constructor(e) {
      e = {
        ...I.defaultOptions,
        ...e
      }, super(e), this.enabled = true, this._state = fe.for2d(), this.blendMode = e.blendMode, this.padding = e.padding, typeof e.antialias == "boolean" ? this.antialias = e.antialias ? "on" : "off" : this.antialias = e.antialias, this.resolution = e.resolution, this.blendRequired = e.blendRequired, this.clipToViewport = e.clipToViewport, this.addResource("uTexture", 0, 1);
    }
    apply(e, t, r, s) {
  ...
  class ve {
    ...
    init() {
      var _a;
      (_a = globalThis.__PIXI_RENDERER_INIT__) == null ? void 0 : _a.call(globalThis, this._renderer, A);
    }
    destroy() {
      this._renderer = null;
    }
...
`;
  ...
  const L = class ge {
    constructor(e, t) {
      var _a, _b;
      this.state = fe.for2d(), this._batchersByInstructionSet = /* @__PURE__ */ Object.create(null), this._activeBatches = /* @__PURE__ */ Object.create(null), this.renderer = e, this._adaptor = t, (_b = (_a = this._adaptor).init) == null ? void 0 : _b.call(_a, this);
    }
    static getBatcher(e) {
    ...
    execute(e) {
      ...
      if (e.action === "pushMaskBegin") {
        ...
        if (s.inverse = e.inverse, r) {
          ...
          const n = ze(e.mask.mask, true, st);
  ...
  class ye {
    ...
    push(e, t, r) {
      ...
      u.instructionsStart = r.instructionSize, o.collectRenderables(r, i, null), o.includeInBuild = false, i.renderPipes.batch.break(r), r.add({
        renderPipeId: "stencilMask",
        action: "pushMaskEnd",
        mask: e,
        inverse: t._maskOptions.inverse,
  ...
  Gt = function(a, e, t, r) {
    ...
    for (let o = 0; o < a.length; o++) {
      ...
      for (let p = 0; p < S.length; p++) if (S[p].test(u.data)) {
        h = u.offset / 4, s.push(`name = "${d}";`, `offset += ${h - n};`, S[p][e] || S[p].ubo), c = true;
        break;
      }
...
`);
  ...
  const W = class Ue {
    constructor() {
      this.clearBeforeRender = true, this._backgroundColor = new ce(0), this.color = this._backgroundColor, this.alpha = 1;
    }
    init(e) {
      e = {
        ...Ue.defaultOptions,
  ...
  class Ee {
    ...
    bind({ size: e, projectionMatrix: t, worldTransformMatrix: r, worldColor: s, offset: n }) {
      ...
      let h;
      this._renderer.renderPipes.uniformBatch ? h = this._renderer.renderPipes.uniformBatch.getUniformBindGroup(d, false) : (h = this._bindGroupPool.pop() || new Ye(), this._activeBindGroups.push(h), h.setResource(d, 0)), u.bindGroup = h, this._currentGlobalUniformData = u;
    }
    push(e) {
  ...
  const j = class Oe {
    ...
    run() {
      ...
      for (let n = 0; n < t.length; n++) {
        ...
        const o = i.renderGroup ?? i.parentRenderGroup, u = ((_a = o == null ? void 0 : o.instructionSet) == null ? void 0 : _a.gcTick) ?? -1;
        if (((o == null ? void 0 : o.gcTick) ?? 0) === u && (i._lastUsed = e), e - i._lastUsed > this.maxUnusedTime) {
          if (!i.destroyed) {
            const d = r;
